...
public interface Aggregator extends Serializable {
  ...
  /**
   * SUM_COUNT and SC_AVG will only be used in lab6, you are not required to
   * implement them until then.
   * */
  public enum Op {
    MIN, MAX, SUM, AVG, COUNT,
    /**
     * SUM_COUNT: compute sum and count simultaneously, will be needed to
     * compute distributed avg in lab6.
     * */
    SUM_COUNT,
    /**
     * SC_AVG: compute the avg of a set of SUM_COUNT tuples, will be used to
     * compute distributed avg in lab6.
     * */
    SC_AVG;
