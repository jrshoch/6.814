...
public class HashEquiJoin extends Operator {
   ...
   * relation. Therefore, there will be two copies of the join attribute in the
   * results. (Removing such duplicate columns can be done with an additional
   * projection operator if needed.)
   * <p>
